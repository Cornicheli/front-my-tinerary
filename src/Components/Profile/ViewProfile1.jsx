        ...
        <div className='main-profile'>
            <div className="flex flex-col items-center relative rounded-xl bg-neutral-100 bg-clip-border shadow-md">
                <div className="flex flex-row items-center justify-around">
                    <NavLink className='text-3xl font-semibold text-gray-700 mx-2 p-2' to={"./"}>Profile</NavLink>

                    <NavLink className='text-3xl font-semibold text-gray-700 mx-2 p-2' to={"./edit"}>Edit Profile</NavLink>
                </div>
